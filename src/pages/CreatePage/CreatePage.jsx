...
const CreatePage = () => {
  ...
  return (
    ...
    <div className="b-container md:px-20 mb-32">
      <h2 className="mt-5 mb-5 text-left text-4xl ">Post Story</h2>
      <div>
        <form
          action=""
          onSubmit={(e) => {
          ...
          onChange={(e)=>{
            ...
            type="text"
            required
            className="w-full py-5 px-4 border border-gray-400 rounded-md outline-none bg-inherit mt-2 mb-5 placeholder:text-gray-400"
          ...
          <button className="text-white bg-green-800 px-3 py-4 w-2/5 rounded-md ">
            Submit
          </button>
        </form>
      </div>
